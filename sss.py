...
#-----------------------------------------------p
            elif msg.text in ["Phet Test","Gu Test"]:              
                ki.sendText(msg.to,"Ok Phet ")
                kk.sendText(msg.to,"on 􀅔Har Har􏿿")
                ki.sendText(msg.to,"Ok Gu ")
                ...
                ki.sendText(msg.to,"Ok Gu ")
                kk.sendText(msg.to,"on 􀜁􀅔􀜁􀅔Har Har􏿿")
                ki.sendText(msg.to,"❦〖Ǥµ ✍Ŧ€₳MжĦ₳ʗҜ฿❂Ŧ✈​✓ ")
                kk.sendText(msg.to,"❦〖Pђëŧ〗☞ᵀËÄMທஇລ❂قB❂T✓ 􏿿")
